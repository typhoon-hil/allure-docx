...
@click.option('--config', default="full", help="Configuration for the docx report. Options are: full, full_on_fail, compact, shipping. Alternatively path to custom .ini configuration file (see documentation).")
